...
<div class="row">
	<div class="col-sm-9">
		{texte nom="promontoire_liste_invasives"}
	</div>
	<div class="col-sm-3">
		<div style="height:5em;"></div>
		<a class="btn btn-primary" href="?page=liste_csv&liste=li"><span class="glyphicon glyphicon-download-alt"></span> Télécharger la liste</a>
	</div>
</div>
{assign var=classe value=''}
{foreach from=$li item=esp name=rl}
