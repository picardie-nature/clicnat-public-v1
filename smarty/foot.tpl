...
<div class="row" id="pied" >
	<div id="pied-cont">
		...
		<div class="col-sm-3">
			...
			<!--
			<div class="text-center">
				<a href="http://www.oise.fr" target="_blank"><div id="logo_cg60" class="hoverscroll"></div></a>
			</div>
			-->
			<div class="text-center">
...
</script><noscript><p><img src="http://stats.picardie-nature.org/piwik.php?idsite=6" style="border:0" alt="" /></p></noscript>
<!-- {/literal} End Piwik Tracking Tag -->
<!-- /globcont -->
</body>
</html>
